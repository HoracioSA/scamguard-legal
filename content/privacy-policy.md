<!--
  ...
  sign-off before you rely on them for actual compliance, particularly:
    - Whether you need an Article 27 GDPR EU representative (Section 8.6)
    - Whether you need a Data Protection Officer (Section 8.7)
    - The actual data processing agreement / transfer mechanism you have (or need)
      with your AI provider and hosting provider (Section 9)
    - Whether CCPA/CPRA even applies to you (revenue/volume thresholds — Section 10)
...
Section 14 ("we," "us," or "our"). [Some jurisdictions — Germany's Impressum
...
Google, or social media account. Section 2 describes exactly what the App does
collect and process instead.

## 2. Information We Collect and Process

### 2.1 Content you submit for analysis

When you use the Analyze feature, we process:
...
This content is sent to our backend and to our third-party AI provider (Section 9)
...
of a directory visible to all users of the App.
...
See Section 8.2 for the legal basis on which we process this.
...
unrelated one is issued the next time you use the App.
...
- For rights beyond this (access, deletion, correction of server-side data), see
  Sections 8 and 10 below, and note the identity-verification limitation described
  there — it applies to all such requests given the App's anonymous design.

## 7. Legal Basis for Processing (applies to users in the EEA, UK, and Switzerland)
...
- **Performance of a contract** (Art. 6(1)(b)): processing your submitted content
  and your anonymous session identifier is necessary to provide the analysis and
  community-reporting features you're actively using, as described in our Terms and
  Conditions.
...
- **Object** to processing based on our legitimate interests (Section 7), unless we
...
### 8.1 A structural limitation: we often cannot verify who you are
...
### 8.2 Your local blocklist and report history are already fully in your control
...
Our servers and our third-party AI provider may process data in countries outside
of where you are located, including the United States. [Add detail here about
where your servers and your AI provider actually process data, relative to your
users' locations.] Where we transfer personal data out of the EEA, UK, or
Switzerland, we rely on appropriate safeguards recognized under GDPR/UK GDPR, such
as the European Commission's Standard Contractual Clauses, to the extent
applicable. [Confirm and reference the actual data processing agreement / transfer
mechanism you have in place with your AI provider and hosting provider — this
cannot be confirmed without knowing your actual vendor agreements.]

### 9.1 Possible obligation to appoint an EU representative
...
### 9.2 Possible obligation to appoint a Data Protection Officer
...
| Customer records, financial, biometric, professional, education, protected-class information | No | Not collected |
...
### 10.2 How we use it and who we disclose it to

Used for the purposes described in Section 2 (providing the analysis and
community-report features, and anti-abuse rate limiting) and disclosed to our
service providers (our hosting infrastructure and our AI provider, Section 3) solely
to provide the App's functionality on our behalf.
...
**The same verification limitation described in Section 8.1 applies here**: our
